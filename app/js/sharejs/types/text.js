...
(function() {
  ...
  text.apply = function(snapshot, op) {
    var comment, component, deleted, _i, _len;
    checkValidOp(op);
    for (_i = 0, _len = op.length; _i < _len; _i++) {
      component = op[_i];
      if (component.i != null) {
        ...
        comment = snapshot.slice(component.p, component.p + component.c.length);
  ...
  text._tc = transformComponent = function(dest, c, otherC, side) {
    var cIntersect, intersectEnd, intersectStart, newC, new_c, offset, otherIntersect, s, _ref;
    checkValidOp([c]);
    checkValidOp([otherC]);
    if (c.i != null) {
      append(dest, {
      ...
      if (otherC.i != null) {
        if ((c.p < (_ref = otherC.p) && _ref < c.p + c.c.length)) {
          offset = otherC.p - c.p;
          new_c = c.c.slice(0, +(offset - 1) + 1 || 9e9) + otherC.i + c.c.slice(offset);
          append(dest, {
            c: new_c,
            p: c.p,
            t: c.t
